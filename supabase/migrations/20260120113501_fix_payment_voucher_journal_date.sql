/*
  # Fix Payment Voucher Journal Entry Date Issue
  
  1. Problem
    - Payment voucher journal function uses CURRENT_DATE instead of voucher_date for JE numbering
    - This should use the voucher_date to match the voucher date
